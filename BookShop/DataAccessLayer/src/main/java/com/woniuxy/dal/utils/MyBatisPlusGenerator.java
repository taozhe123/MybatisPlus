...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        //-----------配置项---------------------------
        String dbUrl="jdbc:mysql://127.0.0.1:3306/woniubookshop03?useSSL=false&serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&autoReconnect=true&rewriteBatchedStatements=true";
        String dbUsername="root";
        String dbPassword="root";
        String[] tableNames = {"t_address","t_book","t_bookcollection","t_booktype","t_china","t_conment","t_manager","t_manager_role","t_order","t_order_item","t_role","t_role_url_permission","t_url_permission","t_user"};


        String authorName="woniumrwang";
        String parentPackage = "com.woniuxy.qiantai";
